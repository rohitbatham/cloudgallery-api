...
export default function(AppEndpoint, email, newPassword){
        ...
        <td valign="top" align="center">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#d2d710;max-width:600px;border-right:1px solid #d2d710;border-left:1px solid #d2d710">
                    ...
                    <td valign="top" align="left" style="font:bold 22px arial;line-height:25px;color:#fff;padding-top:9px;padding-bottom:9px;padding-left:14px">
                            New password for your <span class="il">account</span>
                        </td>
                    </tr>
                </tbody></table>
            ...
            <tbody><tr><td><u></u>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            ...
                            You have requested to reset your password on <a href="${AppEndpoint}" target="_blank" style="outline:none;text-decoration:none;color:#51505d" target="_blank">Cloud Gallery.</a> I would request you to please change your password after logging into your account.
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="font:normal 13px arial;line-height:16px;color:#72727d;text-align:center;padding-bottom:6px">
                                Here the new <span class="il">password</span>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" align="center">
                            <table width="146" cellspacing="0" cellpadding="0" border="0" style="border:1px solid #dfe0e3;border-radius:6px">
                                <tbody><tr>
                                    <td valign="top" style="font:normal 35px arial;line-height:21px;letter-spacing:2.5px;color:#41404d;text-align:center;padding-top:25px;padding-bottom:27px; padding-left:10px; padding-right:10px">
                                        ${newPassword}
                                    </td>
                                </tr>
                            </tbody></table>
                        ...
                        <tr>
                            <td valign="top" style="font:normal 14px arial;line-height:20px;color:#95959d;text-align:left;padding-top:40px;padding-bottom:25px">
                                In case you have not initiated this request, Please immediately <a href="${AppEndpoint}/contact" style="outline:none;text-decoration:none;color:#00bcd5" target="_blank">write to us</a>.
                            </td>
                        </tr>
                        <tr>
