...
export default function(link, username = "User"){
    const html = `<div style="font-family:Calibri, Helvetica, sans-serif; font-size: 14px; color: #111111;">
            <p>Dear ${username}, </p>
            <p>Thanks for getting started with My Menu. You are just one step away to complete your registration. Please Click on the link to verify your email.</p>
            ...
            <p>Team,<br />My Menu</p><hr style="border-top: #555555;"/>
